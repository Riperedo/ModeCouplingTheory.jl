...
K(k,t) = λ(k)Δζ(t)
where 
Δζ(t) = kBT / (36 π ϕ) ∫dq⃗ M^2(k,q) Fs(q,t) F(q,t)
...
The constructor of an MSDSCGLEKernel. It implements the kernel.
...
This is just the G. Naegele formula for shear viscosity relaxation
"""
